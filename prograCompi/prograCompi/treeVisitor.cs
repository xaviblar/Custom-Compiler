...
{
    //Clase que hereda de clase ParserPrograBaseVisitor y sobreescribe los metodos para visitar cada etiqueta del parser
    class treeVisitors : ParserPrograBaseVisitor<object>
    {
        //Variable para llevar el control del numero de nodo hasta el que se adentra en el recorrido del arbol, aumenta cada vez que se visita un hijo y disminuye 
        //cada vez que retrocede recursivamente
        int cont = 0;

        //variable estatica global que almacena todo el arbol de manera que luego pueda ser copiado en el textBox deseado
        public static RichTextBox txtBoxTreeVisitor=new RichTextBox();
